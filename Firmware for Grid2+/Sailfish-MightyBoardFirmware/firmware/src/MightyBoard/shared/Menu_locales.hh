...
const static PROGMEM prog_uchar EXTRUDER1_TEMP_MSG[] =   "RExtrude---/---C";
...
const static PROGMEM prog_uchar MODLE_MSG1[] = 	 ":Grid 2+";
...
const PROGMEM prog_uchar ALEVEL_INACTIVE_MSG[]   = "Auto_level OFF";  // must be 20 chars
const PROGMEM prog_uchar ALEVEL_ACTIVE_MSG[]     = "Auto_level ON ";  // must be 20 chars
