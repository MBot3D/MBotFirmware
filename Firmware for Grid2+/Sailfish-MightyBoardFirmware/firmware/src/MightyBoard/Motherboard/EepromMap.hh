...
#else
	const static uint32_t DUAL_X_OFFSET_STEPS   = 8857L;
        const static uint32_t SINGLE_X_OFFSET_STEPS = 10186L;
	const static uint32_t DUAL_Y_OFFSET_STEPS   =  9300L;
	const static uint32_t SINGLE_Y_OFFSET_STEPS =  9300L;
#endif
	/// Footnote:
	/// mm offsets
	/// XDUAL: 100mm,
...
namespace replicator_axis_lengths{
    ...
    // Replicator 1
    const static uint32_t axis_lengths[5] = {235L, 210L, 185L, 100000L, 100000L};
#else
