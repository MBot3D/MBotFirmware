...
#define LEVELZ_X_OFFSET_SINGLE 17
#define LEVELZ_X_OFFSET_DUAL 65

#define LEVELZ_Y_OFFSET_SINGLE 12
#define LEVELZ_Y_OFFSET_DUAL 0
...
// LCD interface pins
//#define LCD_CS	 Pin(PortG,1)
//#define LCD_RST  Pin(PortG,0)
//#define LCD_DC  Pin(PortK,6)
//#define LCD_MOSI  Pin(PortK,5)
//#define LCD_SCK  Pin(PortK,4)

#define LCD_CS	 Pin(PortC,4) 
#define LCD_RST  Pin(PortC,5) 
#define LCD_DC  Pin(PortC,6)
#define LCD_MOSI  Pin(PortC,3)
#define LCD_SCK  Pin(PortC,2) 
...
#define THERMISTOR1_PIN          13
#define THERMISTOR2_PIN          12
...
#define EX_FAN                  Pin(PortD,7)
#define EXTRA_FET               Pin(PortD,7)
