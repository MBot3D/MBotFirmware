...
#else
	const static uint32_t DUAL_X_OFFSET_STEPS   = 6590L;
        const static uint32_t SINGLE_X_OFFSET_STEPS = 6590L;
	const static uint32_t DUAL_Y_OFFSET_STEPS   =  6590L;
	const static uint32_t SINGLE_Y_OFFSET_STEPS =  6590L;
#endif
	/// Footnote:
	/// mm offsets
	/// XDUAL: 110mm,
...
namespace replicator_axis_lengths{
    ...
    // Replicator 1
    const static uint32_t axis_lengths[5] = {140L, 130L, 130L, 100000L, 100000L};
#else
