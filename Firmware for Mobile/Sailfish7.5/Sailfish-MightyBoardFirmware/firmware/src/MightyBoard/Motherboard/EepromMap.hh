...
namespace replicator_axis_offsets{
	...
	const static uint32_t DUAL_X_OFFSET_STEPS   = 4707L;
        const static uint32_t SINGLE_X_OFFSET_STEPS = 4707L;
	const static uint32_t DUAL_Y_OFFSET_STEPS   =  4236L;
	const static uint32_t SINGLE_Y_OFFSET_STEPS =  4236L;
#else
	const static uint32_t DUAL_X_OFFSET_STEPS   = 4236L;
        const static uint32_t SINGLE_X_OFFSET_STEPS = 4236L;
	const static uint32_t DUAL_Y_OFFSET_STEPS   =  4236L;
	const static uint32_t SINGLE_Y_OFFSET_STEPS =  4236L;
#endif
	/// Footnote:
...
namespace replicator_axis_lengths{
    ...
    // Replicator 1
    const static uint32_t axis_lengths[5] = {90L, 90L, 45L, 100000L, 100000L};
#else
#ifdef SINGLE_EXTRUDER
    // Replicator 2
    const static uint32_t axis_lengths[5] = {100L, 90L, 40L, 100000L, 100000L};
#else
    // Replicator 2X
    const static uint32_t axis_lengths[5] = {100L, 90L, 40L, 100000L, 100000L};
#endif
